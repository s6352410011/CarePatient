...
class CalendarCareUI extends StatefulWidget {
  const CalendarCareUI({Key? key}) : super(key: key);

  @override
  State<CalendarCareUI> createState() => _CalendarCareUIState();
}

class _CalendarCareUIState extends State<CalendarCareUI> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: AllColor.Primary_C, // สีพื้นหลัง
      ),
      body: Column(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: AllColor.Primary_C, // กำหนดสีพื้นหลังของกรอบ
                          ),
                          child: ListTile(
                            title: Text(
                              event.title,
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: AllColor.Primary_C, // สีพื้นหลังของปุ่ม
              ...
              Center(
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor:
                        AllColor.Primary_C, // กำหนดสีพื้นหลังที่นี่
                  ),
                  child: Text(
                    'บันทึก',
          ...
          children: [
            ...
            Center(
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: AllColor.Primary_C, // กำหนดสีพื้นหลังที่นี่
                ),
                child: Text(
